...
<template>
    <div v-if="open"
        class="filter fixed top-0 bottom-0 left-0 h-full w-fullflex items-center justify-center">
        <dialog :open="open" class="bg-transparent w-full">
            <div class="filter__wrapper bg-white flex flex-col m-auto">
                ...
                <form @submit.prevent="updateSponsor" class="flex flex-col w-full">
